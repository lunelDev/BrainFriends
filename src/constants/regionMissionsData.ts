...
export const REGION_MISSIONS: RegionConfig[] = [
        ...
        missions: [
          {
            ...
            placeName: {
              placeNames: ["한강", "경복궁", "남산타워", "광화문", "북촌한옥마을"],
            },
          },
          {
            id: "seoul-2",
            ...
            associationClear: {
              promptPlace: "한강",
              answerWords: ["야경", "치킨", "자전거", "유람선", "피크닉", "강바람", "다리"],
        ...
        missions: [
          {
            ...
            placeName: {
              placeNames: ["차이나타운", "월미도", "송도", "인천공항", "강화도"],
            },
          },
          {
            id: "incheon-2",
            ...
            associationClear: {
              promptPlace: "월미도",
              answerWords: ["바다", "놀이공원", "산책", "야경", "디스코팡팡", "여행"],
          ...
          },
          {
            ...
            tetris: {
              wordPool: ["차이나타운", "송도", "월미도", "공항", "갈매기", "바다", "여행"],
        ...
        missions: [
          {
            ...
            placeName: {
              placeNames: ["광안리", "해운대", "자갈치", "광안대교", "감천문화마을"],
            },
          },
          {
            id: "busan-2",
          ...
          },
          {
            ...
            associationClear: {
              promptPlace: "광안리",
              answerWords: ["바다", "야경", "다리", "해변", "산책", "노을", "축제"],
  ...
  // ───────── 3-8. 나머지 권역 — 도시 골격만 (미션은 추후) ─────────
  {
    id: "gangwon",
    name: "강원",
    description: "산과 바다의 권역",
    cities: [
      { id: "chuncheon", name: "춘천", description: "호수와 닭갈비의 도시", missions: [] },
      { id: "gangneung", name: "강릉", description: "경포대와 커피의 도시", missions: [] },
    ],
  },
  {
    id: "chungcheong",
    ...
    cities: [
      { id: "daejeon", name: "대전", description: "과학과 빵의 도시", missions: [] },
      { id: "cheongju", name: "청주", description: "직지와 가로수의 도시", missions: [] },
    ],
  },
  {
    id: "jeolla",
    ...
    cities: [
      { id: "jeonju", name: "전주", description: "한옥마을과 비빔밥의 도시", missions: [] },
      { id: "yeosu", name: "여수", description: "밤바다의 도시", missions: [] },
      { id: "gwangju", name: "광주", description: "예술과 민주의 도시", missions: [] },
    ],
  },
  {
    id: "gyeongbuk",
    name: "경상북",
    description: "신라와 안동의 권역",
    cities: [
      { id: "gyeongju", name: "경주", description: "천년 고도", missions: [] },
      { id: "andong", name: "안동", description: "하회마을과 탈춤의 도시", missions: [] },
    ],
  },
  {
    id: "daegu",
    name: "대구",
    description: "약령시와 사과의 도시",
    cities: [
      { id: "daegu", name: "대구", description: "동성로와 약령시", missions: [] },
    ],
  },
  {
    id: "jeju",
