module.exports=[70406,(e,t,i)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},93695,(e,t,i)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},23862,e=>e.a(async(t,i)=>{try{let t=await e.y("pg-587764f78a6c7a9c");e.n(t),i()}catch(e){i(e)}},!0),63528,e=>e.a(async(t,i)=>{try{var r=e.i(23862),n=t([r]);[r]=n.then?(await n)():n;let s=process.env.DATABASE_URL;function a(){if(!s)throw Error("missing_database_url");return global.__brainfriendsPgPool||(global.__brainfriendsPgPool=new r.Pool({connectionString:s,ssl:"require"===process.env.DATABASE_SSL&&{rejectUnauthorized:!1}})),global.__brainfriendsPgPool}s||console.warn("[db] DATABASE_URL is not configured. Database writes are disabled."),e.s(["getDbPool",()=>a]),i()}catch(e){i(e)}},!1),77545,e=>e.a(async(t,i)=>{try{var r=e.i(54799),n=e.i(63528),a=t([n]);function s(e){return(0,r.createHash)("sha256").update(e).digest("hex")}function o(e){let t=s(e).slice(0,32).split("");t[12]="5",t[16]=(3&parseInt(t[16],16)|8).toString(16);let i=t.join("");return`${i.slice(0,8)}-${i.slice(8,12)}-${i.slice(12,16)}-${i.slice(16,20)}-${i.slice(20,32)}`}function d(e){return[e.name.trim(),e.birthDate??"",e.gender,e.phone??"",e.language??"ko"].join("|")}function l(e){let t=d(e);return`psn_${s(t).slice(0,24)}`}async function u(e,t){let i=d(t),r=o(`patient:${i}`),n=`PT-${r.slice(0,8).toUpperCase()}`,a=l(t);return await e.query(`
    ...
    `,[a,r,"pseudonym-map-v1"]),{patientId:r,patientCode:n,patientPseudonymId:a}}async function c(e){let t=(0,n.getDbPool)(),i=await t.connect();try{await i.query("BEGIN");let t=await u(i,e);return await i.query("COMMIT"),t}catch(e){throw await i.query("ROLLBACK"),e}finally{i.release()}}[n]=a.then?(await a)():a,e.s(["buildPatientPseudonymId",()=>l,"deterministicUuid",()=>o,"ensurePatientIdentity",()=>c,"hashValue",()=>s,"upsertPatientIdentity",()=>u]),i()}catch(e){i(e)}},!1),66680,(e,t,i)=>{t.exports=e.x("node:crypto",()=>require("node:crypto"))},24868,(e,t,i)=>{t.exports=e.x("fs/promises",()=>require("fs/promises"))},12714,(e,t,i)=>{t.exports=e.x("node:fs/promises",()=>require("node:fs/promises"))},18622,(e,t,i)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},56704,(e,t,i)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},32319,(e,t,i)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},24725,(e,t,i)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},14747,(e,t,i)=>{t.exports=e.x("path",()=>require("path"))},54799,(e,t,i)=>{t.exports=e.x("crypto",()=>require("crypto"))},50227,(e,t,i)=>{t.exports=e.x("node:path",()=>require("node:path"))},57342,e=>{"use strict";var t=e.i(24868),i=e.i(14747),r=e.i(54799);let n=i.default.join(process.cwd(),"data","organizations"),a=i.default.join(n,"registration-requests.json");async function s(){await (0,t.mkdir)(n,{recursive:!0})}function o(e){let{businessLicenseFileDataUrl:t,adminPasswordHash:i,...r}=e;return r}async function d(){await s();try{let e=await (0,t.readFile)(a,"utf8"),i=JSON.parse(e);return Array.isArray(i)?i:[]}catch{return[]}}async function l(e){await s(),await (0,t.writeFile)(a,JSON.stringify(e,null,2),"utf8")}function u(e){return String(e??"").replace(/[^\d-]/g,"").trim()}function c(e){return String(e??"").trim().toLowerCase()}async function p(){return(await d()).sort((e,t)=>e.createdAt<t.createdAt?1:-1).map(o)}async function m(e){let t,i={id:r.default.randomUUID(),organizationName:String(e.organizationName??"").trim(),businessNumber:(t=(e.businessNumber??"").replace(/\D/g,"").slice(0,10)).length<=3?t:t.length<=5?`${t.slice(0,3)}-${t.slice(3)}`:`${t.slice(0,3)}-${t.slice(3,5)}-${t.slice(5,10)}`,representativeName:String(e.representativeName??"").trim(),organizationType:String(e.organizationType??"").trim(),openedDate:function(e){let t=String(e??"").trim();if(t){if(Number.isNaN(new Date(t).getTime()))throw Error("invalid_request_payload");return t}}(e.openedDate),businessLicenseFileName:String(e.businessLicenseFileName??"").trim(),businessLicenseFileDataUrl:String(e.businessLicenseFileDataUrl??"").trim()||void 0,careInstitutionNumber:String(e.careInstitutionNumber??"").trim(),medicalInstitutionCode:String(e.medicalInstitutionCode??"").trim()||void 0,medicalDepartments:String(e.medicalDepartments??"").trim()||void 0,bedCount:"number"==typeof e.bedCount&&Number.isFinite(e.bedCount)?e.bedCount:void 0,organizationPhone:u(e.organizationPhone??""),postalCode:String(e.postalCode??"").trim(),roadAddress:String(e.roadAddress??"").trim(),addressDetail:String(e.addressDetail??"").trim(),contactName:String(e.contactName??"").trim(),contactTitle:String(e.contactTitle??"").trim()||void 0,contactPhone:u(e.contactPhone??""),contactEmail:c(e.contactEmail??""),adminLoginEmail:c(e.adminLoginEmail??"")||void 0,adminPasswordHash:function(e){let t=String(e??"").trim();if(t)return r.default.createHash("sha256").update(t).digest("hex")}(e.adminPassword),twoFactorMethod:"sms"===e.twoFactorMethod?"sms":void 0,billingEmail:c(e.billingEmail??"")||void 0,bankName:String(e.bankName??"").trim()||void 0,bankAccountNumber:String(e.bankAccountNumber??"").trim()||void 0,bankAccountHolder:String(e.bankAccountHolder??"").trim()||void 0,servicePurpose:String(e.servicePurpose??"").trim()||void 0,targetPatients:String(e.targetPatients??"").trim()||void 0,doctorName:String(e.doctorName??"").trim()||void 0,doctorLicenseNumber:String(e.doctorLicenseNumber??"").trim()||void 0,irbStatus:"planned"===e.irbStatus||"approved"===e.irbStatus?e.irbStatus:void 0,termsAgreed:!!e.termsAgreed,privacyAgreed:!!e.privacyAgreed,medicalDataAgreed:!!e.medicalDataAgreed,contractAgreed:!!e.contractAgreed,patientDataAgreed:!!e.patientDataAgreed,status:"pending",createdAt:new Date().toISOString()};if([!!i.organizationName,!!i.businessNumber,!!i.representativeName,!!i.organizationType,!!i.businessLicenseFileName,!!i.careInstitutionNumber,!!i.contactName,!!i.contactEmail,!!i.contactPhone,i.termsAgreed,i.privacyAgreed,i.medicalDataAgreed].some(e=>!e))throw Error("invalid_request_payload");let n=await d();if(n.find(e=>e.organizationName===i.organizationName||e.businessNumber===i.businessNumber||e.careInstitutionNumber===i.careInstitutionNumber))throw Error("organization_already_exists");return n.unshift(i),await l(n),o(i)}async function g(e){let t=await d(),i=t.findIndex(t=>t.id===e.requestId);if(i<0)throw Error("request_not_found");let r=t[i];if("pending"!==r.status)throw Error("request_already_reviewed");let n={...r,status:e.status,reviewedAt:new Date().toISOString(),reviewedBy:String(e.reviewerLoginId??"").trim()||void 0};return t[i]=n,await l(t),o(n)}e.s(["createOrganizationRegistrationRequest",()=>m,"listOrganizationRegistrationRequests",()=>p,"reviewOrganizationRegistrationRequest",()=>g])},92768,e=>{"use strict";var t=e.i(12714),i=e.i(50227),r=e.i(66680);let n=[];var a=e.i(57342);let s=i.default.join(process.cwd(),"data","organizations"),o=i.default.join(s,"manual-organizations.json");async function d(){await (0,t.mkdir)(s,{recursive:!0})}async function l(){await d();try{let e=await (0,t.readFile)(o,"utf8"),i=JSON.parse(e);return Array.isArray(i)?i:[]}catch(e){if("ENOENT"===(e&&"object"==typeof e&&"code"in e?String(e.code):""))return[];throw e}}async function u(e){await d(),await (0,t.writeFile)(o,JSON.stringify(e,null,2),"utf8")}async function c(){let e=await l();return[...n.map(e=>({...e,source:"builtin"})),...e.map(e=>({...e,source:"manual"}))]}async function p(e){return(await c()).find(t=>t.id===e)??null}async function m(e){let t=String(e.name??"").trim(),i=String(e.businessNumber??"").trim(),r=String(e.careInstitutionNumber??"").trim();if(!t&&!i&&!r)return null;for(let e of(await c())){if(t&&e.name===t)return{source:"manual",field:"name",existingId:e.id};let n=e.businessNumber?.trim();if(i&&n&&n===i)return{source:"manual",field:"businessNumber",existingId:e.id};let a=e.careInstitutionNumber?.trim();if(r&&a&&a===r)return{source:"manual",field:"careInstitutionNumber",existingId:e.id}}for(let e of(await (0,a.listOrganizationRegistrationRequests)()))if("pending"===e.status){if(t&&e.organizationName===t)return{source:"request",field:"name",existingId:e.id};if(i&&e.businessNumber===i)return{source:"request",field:"businessNumber",existingId:e.id};if(r&&e.careInstitutionNumber===r)return{source:"request",field:"careInstitutionNumber",existingId:e.id}}return null}async function g(e){let t=String(e??"").trim();return t?(await c()).find(e=>e.name===t)??null:null}async function _(e){let t,i=e.name.trim(),n=e.address.trim();if(!i||!n)throw Error("invalid_organization_payload");let a=await l();if(a.find(t=>t.name===i||t.businessNumber===e.businessNumber))throw Error("organization_already_exists");let s={id:(0,r.randomUUID)(),code:(t=i.replace(/\s+/g,"").slice(0,8).toUpperCase(),`ORG-${t||"CUSTOM"}-${Date.now().toString().slice(-6)}`),name:i,address:n,businessNumber:String(e.businessNumber??"").trim()||void 0,representativeName:String(e.representativeName??"").trim()||void 0,organizationPhone:String(e.organizationPhone??"").trim()||void 0,organizationType:String(e.organizationType??"").trim()||void 0,careInstitutionNumber:String(e.careInstitutionNumber??"").trim()||void 0,medicalInstitutionCode:String(e.medicalInstitutionCode??"").trim()||void 0,medicalDepartments:String(e.medicalDepartments??"").trim()||void 0,postalCode:String(e.postalCode??"").trim()||void 0,roadAddress:String(e.roadAddress??"").trim()||void 0,addressDetail:String(e.addressDetail??"").trim()||void 0,contactName:String(e.contactName??"").trim()||void 0,contactTitle:String(e.contactTitle??"").trim()||void 0,contactPhone:String(e.contactPhone??"").trim()||void 0,contactEmail:String(e.contactEmail??"").trim()||void 0,adminLoginEmail:String(e.adminLoginEmail??"").trim()||void 0,twoFactorMethod:e.twoFactorMethod,servicePurpose:String(e.servicePurpose??"").trim()||void 0,targetPatients:String(e.targetPatients??"").trim()||void 0,doctorName:String(e.doctorName??"").trim()||void 0,doctorLicenseNumber:String(e.doctorLicenseNumber??"").trim()||void 0,createdAt:new Date().toISOString(),source:"manual"};return a.unshift(s),await u(a),s}e.s(["createManagedOrganization",()=>_,"findApprovedOrganizationByName",()=>g,"findOrganizationDuplicate",()=>m,"getAvailableOrganizationById",()=>p,"listAvailableOrganizations",()=>c],92768)},87128,e=>e.a(async(t,i)=>{try{var r=e.i(63528),n=e.i(32476),a=t([r,n]);function s(e){if("string"!=typeof e)return!1;let t=e.trim();return!!t&&(t.startsWith("data:audio/")||t.startsWith("blob:")||t.startsWith("/api/media/access?")||/^https?:\/\//i.test(t))}async function o(e){let t=await (0,n.getAuthenticatedSessionContext)(e);if(!t)throw Error("unauthorized");let i=(0,r.getDbPool)(),[a,o]=await Promise.all([i.query(`
      ...
      `,[t.patientPseudonymId])]),d=[...a.rows,...o.rows].map(e=>({kind:e.kind,trainingType:String(e.training_type),trainingMode:e.training_mode?String(e.training_mode):null,rehabStep:null==e.rehab_step?null:Number(e.rehab_step),sessionId:String(e.session_id),resultId:String(e.result_id),sourceHistoryId:e.source_history_id?String(e.source_history_id):null,aq:null==e.aq?null:Number(e.aq),score:null==e.score?null:Number(e.score),songKey:e.song_key?String(e.song_key):null,completedAt:new Date(e.completed_at).toISOString(),createdAt:new Date(e.created_at).toISOString(),stepScores:e.step_scores?e.step_scores:null,versionSnapshot:e.version_snapshot?e.version_snapshot:null})).sort((e,t)=>t.completedAt.localeCompare(e.completedAt)),l=t.patient,u=Array.from(new Set(a.rows.map(e=>String(e.source_session_key??"").trim()).filter(e=>e.length>0))),c=Array.from(new Set(o.rows.map(e=>String(e.source_session_key??"").trim()).filter(e=>e.length>0))),p=u.length>0?await i.query(`
          ...
          `,[t.patientPseudonymId,u]):{rows:[]},m=u.length>0?await i.query(`
            SELECT
              source_session_key,
              step_no,
              object_key,
          ...
          `,[t.patientPseudonymId,u]):{rows:[]},g=c.length>0?await i.query(`
            SELECT
              source_session_key,
              object_key,
              uploaded_at
    ...
    `,[t.patientPseudonymId]);return{patient:t.patient,hasSelfAssessmentHistory:Number(a.rows[0]?.row_count??0)>0}}async function l(e,t){let i=await (0,n.getAuthenticatedSessionContext)(e);if(!i)throw Error("unauthorized");let a=Array.from(new Set(t.map(e=>String(e||"").trim()).filter(e=>e.length>0)));if(!a.length)return{deletedCount:0};let s=(0,r.getDbPool)(),o=await s.connect();try{await o.query("BEGIN");let e=(await o.query(`
      ...
      `,[i.patientPseudonymId,e]),await o.query(`
        ...
        WHERE patient_pseudonym_id = $1
          AND session_id::text = ANY($2::text[])
      `,[i.patientPseudonymId,e]),await o.query("COMMIT"),{deletedCount:e.length}}catch(e){throw await o.query("ROLLBACK"),e}finally{o.release()}}[r,n]=a.then?(await a)():a,e.s(["deleteHistoryEntriesForAuthenticatedUser",()=>l,"getOnboardingStatusForAuthenticatedUser",()=>d,"listHistoryForAuthenticatedUser",()=>o]),i()}catch(e){i(e)}},!1),85160,e=>e.a(async(t,i)=>{try{var r=e.i(93458),n=e.i(89171),a=e.i(32476),s=e.i(87128),o=t([a,s]);async function d(){let e=await (0,r.cookies)(),t=e.get(a.AUTH_COOKIE_NAME)?.value;if(!t)return n.NextResponse.json({ok:!1,error:"unauthorized"},{status:401});try{let e=await (0,s.listHistoryForAuthenticatedUser)(t);return n.NextResponse.json({ok:!0,...e})}catch(t){let e=t instanceof Error?t.message:"failed_to_load_history";return n.NextResponse.json({ok:!1,error:e},{status:"unauthorized"===e?401:500})}}async function l(e){let t=await (0,r.cookies)(),i=t.get(a.AUTH_COOKIE_NAME)?.value;if(!i)return n.NextResponse.json({ok:!1,error:"unauthorized"},{status:401});let o=await e.json().catch(()=>null),d=Array.isArray(o?.sessionIds)?o.sessionIds.map(e=>String(e)):[];try{let e=await (0,s.deleteHistoryEntriesForAuthenticatedUser)(i,d);return n.NextResponse.json({ok:!0,...e})}catch(t){let e=t instanceof Error?t.message:"failed_to_delete_history";return n.NextResponse.json({ok:!1,error:e},{status:"unauthorized"===e?401:500})}}[a,s]=o.then?(await o)():o,e.s(["DELETE",()=>l,"GET",()=>d,"dynamic",0,"force-dynamic","runtime",0,"nodejs"]),i()}catch(e){i(e)}},!1),57796,e=>e.a(async(t,i)=>{try{var r=e.i(47909),n=e.i(74017),a=e.i(96250),s=e.i(59756),o=e.i(61916),d=e.i(74677),l=e.i(69741),u=e.i(16795),c=e.i(87718),p=e.i(95169),m=e.i(47587),g=e.i(66012),_=e.i(70101),y=e.i(26937),h=e.i(10372),f=e.i(93695);e.i(52474);var S=e.i(220),N=e.i(85160),b=t([N]);[N]=b.then?(await b)():b;let E=new r.AppRouteRouteModule({definition:{kind:n.RouteKind.APP_ROUTE,page:"/api/history/me/route",pathname:"/api/history/me",filename:"route",bundlePath:""},distDir:".next-sandbox4",relativeProjectDir:"",resolvedPagePath:"[project]/src/app/api/history/me/route.ts",nextConfigOutput:"",userland:N}),{workAsyncStorage:v,workUnitAsyncStorage:x,serverHooks:R}=E;function A(){return(0,a.patchFetch)({workAsyncStorage:v,workUnitAsyncStorage:x})}async function w(e,t,i){E.isDev&&(0,s.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let r="/api/history/me/route";r=r.replace(/\/index$/,"")||"/";let a=await E.prepare(e,t,{srcPage:r,multiZoneDraftMode:!1});if(!a)return t.statusCode=400,t.end("Bad Request"),null==i.waitUntil||i.waitUntil.call(i,Promise.resolve()),null;let{buildId:N,params:b,nextConfig:A,parsedUrl:w,isDraftMode:v,prerenderManifest:x,routerServerContext:R,isOnDemandRevalidate:D,revalidateOnlyGenerated:I,resolvedPathname:C,clientReferenceManifest:O,serverActionsManifest:L}=a,U=(0,l.normalizeAppPath)(r),P=!!(x.dynamicRoutes[U]||x.routes[C]),k=async()=>((null==R?void 0:R.render404)?await R.render404(e,t,w,!1):t.end("This page could not be found"),null);if(P&&!v){let e=!!x.routes[C],t=x.dynamicRoutes[U];if(t&&!1===t.fallback&&!e){if(A.experimental.adapterPath)return await k();throw new f.NoFallbackError}}let T=null;!P||E.isDev||v||(T=C,T="/index"===T?"/":T);let q=!0===E.isDev||!P,j=P&&!q;L&&O&&(0,d.setManifestsSingleton)({page:r,clientReferenceManifest:O,serverActionsManifest:L});let $=e.method||"GET",M=(0,o.getTracer)(),z=M.getActiveScopeSpan(),H={params:b,prerenderManifest:x,renderOpts:{experimental:{authInterrupts:!!A.experimental.authInterrupts},cacheComponents:!!A.cacheComponents,supportsDynamicResponse:q,incrementalCache:(0,s.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:A.cacheLife,waitUntil:i.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,i,r,n)=>E.onRequestError(e,t,r,n,R)},sharedContext:{buildId:N}},F=new u.NodeNextRequest(e),W=new u.NodeNextResponse(t),B=c.NextRequestAdapter.fromNodeNextRequest(F,(0,c.signalFromNodeResponse)(t));try{let a=async e=>E.handle(B,H).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let i=M.getRootSpanAttributes();if(!i)return;if(i.get("next.span_type")!==p.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${i.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let n=i.get("next.route");if(n){let t=`${$} ${n}`;e.setAttributes({"next.route":n,"http.route":n,"next.span_name":t}),e.updateName(t)}else e.updateName(`${$} ${r}`)}),d=!!(0,s.getRequestMeta)(e,"minimalMode"),l=async s=>{var o,l;let u=async({previousCacheEntry:n})=>{try{if(!d&&D&&I&&!n)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let r=await a(s);e.fetchMetrics=H.renderOpts.fetchMetrics;let o=H.renderOpts.pendingWaitUntil;o&&i.waitUntil&&(i.waitUntil(o),o=void 0);let l=H.renderOpts.collectedTags;if(!P)return await (0,g.sendResponse)(F,W,r,H.renderOpts.pendingWaitUntil),null;{let e=await r.blob(),t=(0,_.toNodeOutgoingHttpHeaders)(r.headers);l&&(t[h.NEXT_CACHE_TAGS_HEADER]=l),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let i=void 0!==H.renderOpts.collectedRevalidate&&!(H.renderOpts.collectedRevalidate>=h.INFINITE_CACHE)&&H.renderOpts.collectedRevalidate,n=void 0===H.renderOpts.collectedExpire||H.renderOpts.collectedExpire>=h.INFINITE_CACHE?void 0:H.renderOpts.collectedExpire;return{value:{kind:S.CachedRouteKind.APP_ROUTE,status:r.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:i,expire:n}}}}catch(t){throw(null==n?void 0:n.isStale)&&await E.onRequestError(e,t,{routerKind:"App Router",routePath:r,routeType:"route",revalidateReason:(0,m.getRevalidateReason)({isStaticGeneration:j,isOnDemandRevalidate:D})},!1,R),t}},c=await E.handleResponse({req:e,nextConfig:A,cacheKey:T,routeKind:n.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:x,isRoutePPREnabled:!1,isOnDemandRevalidate:D,revalidateOnlyGenerated:I,responseGenerator:u,waitUntil:i.waitUntil,isMinimalMode:d});if(!P)return null;if((null==c||null==(o=c.value)?void 0:o.kind)!==S.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==c||null==(l=c.value)?void 0:l.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});d||t.setHeader("x-nextjs-cache",D?"REVALIDATED":c.isMiss?"MISS":c.isStale?"STALE":"HIT"),v&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let p=(0,_.fromNodeOutgoingHttpHeaders)(c.value.headers);return d&&P||p.delete(h.NEXT_CACHE_TAGS_HEADER),!c.cacheControl||t.getHeader("Cache-Control")||p.get("Cache-Control")||p.set("Cache-Control",(0,y.getCacheControlHeader)(c.cacheControl)),await (0,g.sendResponse)(F,W,new Response(c.value.body,{headers:p,status:c.value.status||200})),null};z?await l(z):await M.withPropagatedContext(e.headers,()=>M.trace(p.BaseServerSpan.handleRequest,{spanName:`${$} ${r}`,kind:o.SpanKind.SERVER,attributes:{"http.method":$,"http.target":e.url}},l))}catch(t){if(t instanceof f.NoFallbackError||await E.onRequestError(e,t,{routerKind:"App Router",routePath:U,routeType:"route",revalidateReason:(0,m.getRevalidateReason)({isStaticGeneration:j,isOnDemandRevalidate:D})},!1,R),P)throw t;return await (0,g.sendResponse)(F,W,new Response(null,{status:500})),null}}e.s(["handler",()=>w,"patchFetch",()=>A,"routeModule",()=>E,"serverHooks",()=>R,"workAsyncStorage",()=>v,"workUnitAsyncStorage",()=>x]),i()}catch(e){i(e)}},!1)];

//# sourceMappingURL=%5Broot-of-the-server%5D__bf0bfe2f._.js.map