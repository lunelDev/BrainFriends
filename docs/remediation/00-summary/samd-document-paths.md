# BrainFriends SaMD 관련 문서 경로 정리

## 목적

이 문서는 BrainFriends에서 SaMD 및 공인성적서 대응을 위해 정리한 핵심 문서 경로를 한 번에 보기 위한 인덱스입니다.
...
- 날짜별 SW V&V 실행 로그 폴더:
  - `C:/Users/pc/Desktop/ProjectFiles/BrainFriends/docs/remediation/test-runs/`
...
1. 제품 정의 1장
2. 공인성적서 대응 준비 현황
3. 시험기관 사전 문의 1페이지 요약본
4. SaMD 준비 부족 항목 체크리스트
5. 각 영역별 제출 개요 문서
